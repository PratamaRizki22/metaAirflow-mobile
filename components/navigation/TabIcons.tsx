...
export const SearchIcon = ({ width = 24, height = 24, color = '#00B87C' }: IconProps) => (
...
export const HomeIcon = ({ width = 24, height = 24, color = '#00B87C' }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
        <Path
...
export const MessagesIcon = ({ width = 24, height = 24, color = '#00B87C' }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
        <Path
...
export const TripsIcon = ({ width = 24, height = 24, color = '#00B87C' }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
        <Rect
            x="3"
            y="4"
...
export const FavoritesIcon = ({ width = 24, height = 24, color = '#00B87C' }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
        <Path
...
export const ProfileIcon = ({ width = 24, height = 24, color = '#00B87C' }: IconProps) => (
    <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
        <Path
